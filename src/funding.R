...
# candidate names
candidates = c("Biden", "Bloomberg", "Buttigieg", "Gabbard", "Sanders", "Warren")

# fund from Nevada
nevada_fund = c(832.7, 0, 178.9, 42.6, 109.3, 90.1) 
...
# fund from Virginia
virginia_fund = c(387.5, 1.0, 1724.4, 71.8, 286.1, 387.5) 
...
# fund from Vermont
vermont_fund = c(113.4, 0, 91.0, 16.8, 10325.8, 83.9) 
...
scarolina_fund = c(418.8, 0, 301.8, 1.5, 77.8, 57.7) 
...
# fund from Texas
texas_fund = c(1826.8, 1.3, 1853.4, 255.9, 544.2, 662.6) 
...
# fund from Georgia
georgia_fund = c(670.3, 0.6, 920.6, 55.4, 198.7, 211.6) 
...
# fund from Florida
florida_fund = c(3537.9, 1.1, 2361.6, 190.7, 484.5, 474.8) 
